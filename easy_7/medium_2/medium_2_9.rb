...
# A bubble sort works by making multiple passes (iterations) through the Array. On each pass, each
# pair of consecutive elements is compared. If the first of the two elements is greater than the
# second, then the two elements are swapped. This process is repeated until a complete pass is made
...
# input: array
# output: sorted array
# rules: array has at least two elements
# algorithm:

  # loop
  # variable = true
  # 0.upto(arr.length)
    # if first is bigger then second, parallel reassignment
      # variable = false
  # break if variable == true
