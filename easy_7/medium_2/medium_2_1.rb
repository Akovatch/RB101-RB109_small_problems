...
# Split text into an array of sentences using regex hing
# Iterate over each (.each) sentence (each sentence is a single element of the array)
#   - Split each sentence into an array of words
#   - Count words - .count? size?
#   - Store longest sentence in a variable - it will be replaced if a new sentence is longer
