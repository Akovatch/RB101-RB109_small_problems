...
# Write a method that takes an arbitrary matrix and rotates it 90
# degrees clockwise as shown above.
...
def rotate90(array) # all I had to do was add 'revese' to my previous method
  results = []
  (0...array[0].length).each do |index|
    row = []
    array.reverse.each { |sub_array| row << sub_array[index] }
    results << row
  end
  results
end
