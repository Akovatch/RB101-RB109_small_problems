...
# input: matrix (3 nested arrays of 3 elements each)
# output: a transposed matrix (a new object)
# rules:
  # cannot mutate original array of arrays

# algorithm:
  # init results array - [[], [], []]
  # iterate from 0 upto 2 |index1|
    # iterate over matrix, for each sub_array
      # push element at index1 into results array
  # return results
...
# LS solution: constructed each row with map, then pushed it into results
