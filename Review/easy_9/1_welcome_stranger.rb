...
# will produce a person's name. The hash will contain two keys, :title
# and :occupation, and the appropriate values. Your method should return
# a greeting that uses the person's full name, and mentions the
