...
# You may, however, use the string_to_integer method from
# the previous lesson.
...
# Take-away: you can select a range of characters in a string. This
# is a good way to work around the fact that there is no .shift method
# for strings
