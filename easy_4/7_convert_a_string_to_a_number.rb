...
# similarly. In this exercise, you will create a method that
# does the same thing.
...
# Integer(), etc. Your method should do this the old-fashioned
# way and calculate the result by analyzing the characters in
# the string.
...
# NOTE: the takeaway is to use a hash to perform conversions
