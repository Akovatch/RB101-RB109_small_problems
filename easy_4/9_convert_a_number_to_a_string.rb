# In the previous two exercises, you developed methods that
# convert simple numeric strings to signed Integers.
...
# LS solution: uses an array because in this case index # is equal
# to the value. They also use divmod(10) as a way to pop off
